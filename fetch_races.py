...
FF_CACHE_DAYS = 10     # reuse a cached horse profile (with stats) for this many days
FF_MISS_DAYS  = 2      # remember a "no stats" miss for this many days before re-checking
...
FF_EVERY_HOURS = 1          # how often FormFav enrichment ACTUALLY runs (odds still refresh every run)
FF_HORIZON_HOURS = 48       # enrich up to 48h out — covers all of today AND tomorrow (20k/day quota is ample)
